...
if top_10_h3:
    top_10_list = top_10_h3.find_element(By.XPATH, 'following-sibling::ol')

    link_elements = top_10_list.find_elements(By.CSS_SELECTOR, 'a')
...
df.to_csv("python_homework/assignment8/owasp_top_10.csv", index=False)
